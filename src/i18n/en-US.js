export default {
  ...
  tablesEdit: {
    ...
    unsavedChanges:
      "You have unsaved changes. Remember to save before reloading the page.",
    // Default values for new rows
    defaultCoverTypeIt: "new type",
    defaultCoverTypeEn: "new type",
    defaultPublisher: "insert publisher",
    defaultSeries: "insert series",
    defaultLanguage: "insert language",
    // Validation messages
    valueRequired: "Value cannot be empty",
    publisherRequired: "Publisher name cannot be empty",
    seriesRequired: "Series name cannot be empty",
    languageRequired: "Language name cannot be empty",
    selectValidPublisher: "Select a valid publisher",
    invalidRow: "Internal error: invalid row",
    invalidPublisher: "Internal error: invalid publisher",
    invalidSeries: "Internal error: invalid series",
    invalidLanguage: "Internal error: invalid language",
    // Success messages
    coversSaved: "Cover types saved successfully",
    publisherSaved: "Publisher saved successfully",
    seriesSaved: "Series saved successfully",
    languageSaved: "Language saved successfully",
    // Error messages
    errorSavingCovers: "Error saving cover types",
    errorSavingPublisher: "Error saving publisher",
    errorSavingSeries: "Error saving series",
    errorSavingLanguage: "Error saving language",
    errorAddingCover: "Error adding cover type",
    errorAddingPublisher: "Error adding publisher",
    ...
    itemInUseMessage: "This item is used in the following books:",
    itemNotUsed: "Item not used",
    itemNotUsedMessage: "This item is not used in any book. It can be deleted.",
